...
namespace Api_Link_up.Migrations
{
    ...
    [Migration("20240905115445_UpdatedCoderModel")]
    partial class UpdatedCoderModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Api_Link_up.Models.Coder", b =>
                {
                    ...
                    b.Property<List<int>>("LanguageLevelIds")
                        .IsRequired()
                        .HasColumnType("integer[]");
                    ...
                    b.Property<List<int>>("SoftSkillIds")
                        .IsRequired()
                        .HasColumnType("integer[]");

                    b.Property<List<int>>("TechnicalSkillLevelIds")
                        .IsRequired()
                        .HasColumnType("integer[]");
